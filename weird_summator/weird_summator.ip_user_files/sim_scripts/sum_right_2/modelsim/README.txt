...
#
# Generated by export_simulation on Wed Apr 05 10:21:58 CEST 2017
#
################################################################################
...
switch to the './sum_right_2.sh' script.

./sum_right_2.sh -reset_run
...
./sum_right_2.sh -noclean_files

For more information on the script, please type './sum_right_2.sh -help'.
