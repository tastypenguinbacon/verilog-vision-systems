...
HD_PWD='/home/pingwin/Dokumenty/Verilog/weird_summator/weird_summator.runs/mul_right_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_right.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_right.tcl
