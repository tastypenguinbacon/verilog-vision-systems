...
HD_PWD='/home/pingwin/Dokumenty/Verilog/weird_summator/weird_summator.runs/sum_right_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_right_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_right_2.tcl
