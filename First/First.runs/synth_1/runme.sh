...
HD_PWD='/home/pingwin/Dokumenty/Verilog/First/First.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log big_and.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source big_and.tcl
