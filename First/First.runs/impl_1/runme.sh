...
HD_PWD='/home/pingwin/Dokumenty/Verilog/First/First.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log big_and.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source big_and.tcl -notrace
