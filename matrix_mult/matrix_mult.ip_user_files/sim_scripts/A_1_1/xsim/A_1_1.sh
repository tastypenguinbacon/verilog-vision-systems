...
#
# Generated by Vivado on Wed Apr 12 11:37:52 CEST 2017
# IP Build 1755317 on Mon Jan 23 20:30:07 MST 2017 
#
# usage: A_1_1.sh [-help]
# usage: A_1_1.sh [-lib_map_path]
# usage: A_1_1.sh [-noclean_files]
# usage: A_1_1.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "A_1_1.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L xbip_pipe_v3_0_3 -L xbip_bram18k_v3_0_3 -L mult_gen_v12_0_12 -L xil_defaultlib -L secureip -L xpm --snapshot A_1_1 xil_defaultlib.A_1_1 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim A_1_1 -key {Behavioral:sim_1:Functional:A_1_1} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./A_1_1.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb A_1_1.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./A_1_1.sh -help\" for more information)\n"
    exit 1
  fi
