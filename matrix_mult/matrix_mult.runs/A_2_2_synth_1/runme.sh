...
HD_PWD='/home/pingwin/Dokumenty/Verilog/matrix_mult/matrix_mult.runs/A_2_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log A_2_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source A_2_2.tcl
