...
HD_PWD='/home/pingwin/Dokumenty/Verilog/matrix_mult/matrix_mult.runs/Y_sum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Y_sum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Y_sum.tcl
