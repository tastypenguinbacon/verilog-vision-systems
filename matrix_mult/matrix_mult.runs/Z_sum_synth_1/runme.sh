...
HD_PWD='/home/pingwin/Dokumenty/Verilog/matrix_mult/matrix_mult.runs/Z_sum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Z_sum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Z_sum.tcl
