...
HD_PWD='/home/pingwin/Dokumenty/Verilog/rgb2ycbcr/rgb2ycbcr.runs/cb_sum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cb_sum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cb_sum.tcl
