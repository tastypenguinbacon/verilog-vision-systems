...
HD_PWD='/home/pingwin/Dokumenty/Verilog/rgb2ycbcr/rgb2ycbcr.runs/cr_sum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cr_sum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cr_sum.tcl
