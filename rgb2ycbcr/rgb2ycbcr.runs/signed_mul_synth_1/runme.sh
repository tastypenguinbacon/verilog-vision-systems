...
HD_PWD='/home/pingwin/Dokumenty/Verilog/rgb2ycbcr/rgb2ycbcr.runs/signed_mul_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signed_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signed_mul.tcl
