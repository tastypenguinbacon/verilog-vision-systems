...
HD_PWD='/home/pingwin/Dokumenty/Verilog/rgb2ycbcr/rgb2ycbcr.runs/long_short_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log long_short.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source long_short.tcl
