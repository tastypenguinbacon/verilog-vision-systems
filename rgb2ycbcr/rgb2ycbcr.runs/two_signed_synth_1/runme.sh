...
HD_PWD='/home/pingwin/Dokumenty/Verilog/rgb2ycbcr/rgb2ycbcr.runs/two_signed_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_signed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_signed.tcl
