...
#
# Generated by export_simulation on Wed Apr 26 17:59:47 CEST 2017
#
################################################################################
...
switch to the './cr_sum.sh' script.
...
./cr_sum.sh -noclean_files

For more information on the script, please type './cr_sum.sh -help'.
