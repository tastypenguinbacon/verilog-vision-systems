...
#
# Generated by export_simulation on Wed Apr 26 17:59:23 CEST 2017
#
################################################################################
...
switch to the './cb_sum.sh' script.
...
./cb_sum.sh -noclean_files

For more information on the script, please type './cb_sum.sh -help'.
