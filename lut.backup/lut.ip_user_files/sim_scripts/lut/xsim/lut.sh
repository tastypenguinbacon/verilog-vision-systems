...
#
# Generated by Vivado on Wed Apr 05 12:50:57 CEST 2017
...
# Script info
echo -e "lut.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_11 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot lut xil_defaultlib.lut xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim lut -key {Behavioral:sim_1:Functional:lut} -tclbatch cmd.tcl -log simulate.log
}
