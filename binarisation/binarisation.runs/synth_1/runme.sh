...
HD_PWD='/home/pingwin/Dokumenty/Verilog/binarisation/binarisation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binarisation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binarisation.tcl
