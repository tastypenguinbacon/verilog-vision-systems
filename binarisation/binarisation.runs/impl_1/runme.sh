...
HD_PWD='/home/pingwin/Dokumenty/Verilog/binarisation/binarisation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log binarisation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source binarisation.tcl -notrace
