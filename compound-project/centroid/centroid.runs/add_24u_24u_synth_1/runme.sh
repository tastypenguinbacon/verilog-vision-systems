...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/centroid/centroid.runs/add_24u_24u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_24u_24u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_24u_24u.tcl
