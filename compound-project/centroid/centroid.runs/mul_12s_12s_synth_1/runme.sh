...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/centroid/centroid.runs/mul_12s_12s_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_12s_12s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_12s_12s.tcl
