...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/add_32u_11u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_32u_11u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_32u_11u.tcl
