...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/summatr_12u_12u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log summatr_12u_12u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source summatr_12u_12u.tcl
