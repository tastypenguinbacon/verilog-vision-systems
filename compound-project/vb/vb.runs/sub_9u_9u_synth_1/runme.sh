...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/sub_9u_9u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_9u_9u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_9u_9u.tcl
