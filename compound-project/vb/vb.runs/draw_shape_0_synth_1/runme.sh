...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/draw_shape_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log draw_shape_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source draw_shape_0.tcl
