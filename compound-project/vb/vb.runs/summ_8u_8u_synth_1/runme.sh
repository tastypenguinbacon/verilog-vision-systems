...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/summ_8u_8u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log summ_8u_8u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source summ_8u_8u.tcl
