...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vb.tcl -notrace
