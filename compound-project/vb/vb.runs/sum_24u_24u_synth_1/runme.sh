...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/sum_24u_24u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_24u_24u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_24u_24u.tcl
