...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/summ_11s_11s_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log summ_11s_11s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source summ_11s_11s.tcl
