...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vb.tcl
