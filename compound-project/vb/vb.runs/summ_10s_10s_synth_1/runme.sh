...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/vb/vb.runs/summ_10s_10s_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log summ_10s_10s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source summ_10s_10s.tcl
