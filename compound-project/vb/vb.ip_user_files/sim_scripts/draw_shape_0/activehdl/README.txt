...
#
# Generated by export_simulation on Sun Jun 11 20:18:23 CEST 2017
#
################################################################################
...
switch to the './draw_shape_0.sh' script.

./draw_shape_0.sh -reset_run
...
./draw_shape_0.sh -noclean_files

For more information on the script, please type './draw_shape_0.sh -help'.
