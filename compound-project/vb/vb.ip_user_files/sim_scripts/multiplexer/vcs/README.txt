...
#
# Generated by export_simulation on Wed Jun 07 17:49:50 CEST 2017
#
################################################################################
...
switch to the './multiplexer.sh' script.

./multiplexer.sh -reset_run
...
./multiplexer.sh -noclean_files

For more information on the script, please type './multiplexer.sh -help'.
