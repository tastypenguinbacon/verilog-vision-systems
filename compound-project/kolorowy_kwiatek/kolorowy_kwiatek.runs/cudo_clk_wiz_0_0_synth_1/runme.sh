...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/kolorowy_kwiatek/kolorowy_kwiatek.runs/cudo_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cudo_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cudo_clk_wiz_0_0.tcl
