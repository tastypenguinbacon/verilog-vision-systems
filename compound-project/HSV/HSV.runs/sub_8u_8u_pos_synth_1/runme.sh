...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/HSV/HSV.runs/sub_8u_8u_pos_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_8u_8u_pos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_8u_8u_pos.tcl
