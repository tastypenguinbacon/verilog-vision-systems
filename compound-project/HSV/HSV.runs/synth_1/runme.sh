...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/HSV/HSV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log h_calculation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source h_calculation.tcl
