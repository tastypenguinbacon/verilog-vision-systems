...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/HSV/HSV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log h_calculation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source h_calculation.tcl -notrace
