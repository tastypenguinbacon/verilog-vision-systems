...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/HSV/HSV.runs/mul_10s_7u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_10s_7u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_10s_7u.tcl
