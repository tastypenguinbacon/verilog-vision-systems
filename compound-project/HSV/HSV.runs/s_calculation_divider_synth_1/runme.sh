...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/HSV/HSV.runs/s_calculation_divider_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s_calculation_divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s_calculation_divider.tcl
