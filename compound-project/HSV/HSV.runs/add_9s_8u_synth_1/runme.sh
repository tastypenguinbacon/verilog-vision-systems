...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/HSV/HSV.runs/add_9s_8u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_9s_8u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_9s_8u.tcl
