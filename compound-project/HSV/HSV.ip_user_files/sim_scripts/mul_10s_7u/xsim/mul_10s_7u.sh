...
#
# Generated by Vivado on Sat Jun 10 22:44:36 CEST 2017
# IP Build 1755317 on Mon Jan 23 20:30:07 MST 2017 
#
# usage: mul_10s_7u.sh [-help]
# usage: mul_10s_7u.sh [-lib_map_path]
# usage: mul_10s_7u.sh [-noclean_files]
# usage: mul_10s_7u.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "mul_10s_7u.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L xbip_pipe_v3_0_3 -L xbip_bram18k_v3_0_3 -L mult_gen_v12_0_12 -L xil_defaultlib -L secureip -L xpm --snapshot mul_10s_7u xil_defaultlib.mul_10s_7u -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim mul_10s_7u -key {Behavioral:sim_1:Functional:mul_10s_7u} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./mul_10s_7u.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mul_10s_7u.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./mul_10s_7u.sh -help\" for more information)\n"
    exit 1
  fi
