...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/tor-wizyjny/tor-wizyjny.runs/hdmi_vga_xlconcat_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_vga_xlconcat_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_vga_xlconcat_0_2.tcl
