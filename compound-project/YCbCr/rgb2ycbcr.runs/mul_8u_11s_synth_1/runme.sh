...
HD_PWD='/home/pingwin/Dokumenty/Verilog/compound-project/YCbCr/rgb2ycbcr.runs/mul_8u_11s_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_8u_11s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_8u_11s.tcl
