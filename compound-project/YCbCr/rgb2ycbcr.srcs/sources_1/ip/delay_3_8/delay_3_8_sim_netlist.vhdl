...
-- Date        : Wed May 24 23:47:24 2017
-- Host        : mothership running 64-bit Ubuntu 16.10
-- Command     : write_vhdl -force -mode funcsim
--               /home/pingwin/Dokumenty/Verilog/compound-project/YCbCr/rgb2ycbcr.srcs/sources_1/ip/delay_3_8/delay_3_8_sim_netlist.vhdl
-- Design      : delay_3_8
...
entity delay_3_8_delay is
  ...
  attribute ORIG_REF_NAME of delay_3_8_delay : entity is "delay";
end delay_3_8_delay;

architecture STRUCTURE of delay_3_8_delay is
...
entity delay_3_8 is
  ...
  attribute NotValidForBitStream of delay_3_8 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of delay_3_8 : entity is "delay_3_8,delay,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of delay_3_8 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of delay_3_8 : entity is "delay,Vivado 2016.4";
end delay_3_8;

architecture STRUCTURE of delay_3_8 is
begin
inst: entity work.delay_3_8_delay
     port map (
      clk => clk,
